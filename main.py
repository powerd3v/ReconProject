...
while True:
    ...
    if choice == "1":
       ...
       while True:
            ...
            print("2- valoidate phone number")
            print("3 - Return to main menu")
            ...
            if validation_choice == "1":
                ...
                # validate email from text
                emails = validation.validate_email(text)
                save_results(emails)
                
            elif validation_choice == "2":
                # ask for text
                text = input("Enter your phone number to validate: ")
                # validate phone numbers from text
                phone_numbers = validation.validate_phone_number(text)
